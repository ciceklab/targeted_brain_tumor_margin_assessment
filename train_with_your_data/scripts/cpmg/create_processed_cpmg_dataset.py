...
dataset_spectra_path = os.path.join(base, "data/cpmg")
raw_data_path = os.path.join(base, "data/raw_data_cpmg/")

# read excel sheets to pandas dataframe
statistics_df = pd.read_excel(dataset_excel_path, sheet_name="CPMG Data (Statistics)")
quantification_df = pd.read_excel(dataset_excel_path, sheet_name="CPMG Data (Metabolites)")
