...
model_name = f"cropped/RF/seed_{SEED}/"
model_base_path = os.path.join(base, "models/eretic_cpmg/pathologic_classification/benign_aggressive/raw_spectrum/"+model_name)
log_base_path = os.path.join(base, "logs/eretic_cpmg/pathologic_classification/benign_aggressive/raw_spectrum/"+model_name)
plot_base_path = os.path.join(base, "plots/eretic_cpmg/pathologic_classification/benign_aggressive/raw_spectrum/"+model_name)
